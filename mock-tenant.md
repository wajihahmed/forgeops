...
The exact implementation is to be researched. Options 1 and 2 together are likely the right starting point — `sync-config` for quick persistence, `save-config` for changes meant to be committed to the repo.
