...
*
* Copyright (c) 2020-2024 Ping Identity Corporation. Use of this source code is subject to the
...
class BenchConfig {
    val host: String   = Properties.envOrElse("TARGET_HOST", "mock.iam.example.com")
